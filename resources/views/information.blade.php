<div class="container">
			...
			<div class="row" style="padding: 19px;">
				    <div style="background-image: url(images/CHAM.jpg); background-repeat: no-repeat; background-position: center; background-size: cover; width: 100%;height: 400px;margin-top: 15px;">
